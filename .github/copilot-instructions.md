...
- Application web moderne avec Symfony 8
- Architecture RESTful et/ou MVC classique
- Interface utilisateur réactive avec Stimulus/Turbo
- Gestion de données avec Doctrine ORM
